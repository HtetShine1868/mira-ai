...
const ai = new GoogleGenAI({
    apiKey: isApiKeyConfigured ? apiKey : 'mock_key',
});
// ─────────────────────────────────────────────────────────────────────────────
// MOCK RESPONSES
...
const MOCK_SCENARIOS = [
    ...
    // Scenario 3: Safe content
    {
        ...
        explanation: 'This page has been verified as safe. The domain is the legitimate Google homepage, the HTTPS certificate is valid and trusted, and the visual design matches Google\'s official brand guidelines. No phishing indicators, suspicious form fields, or social engineering tactics were detected.',
        recommendedActions: [
    ...
    // Scenario 4: Medium – Scam (fake prize/lottery)
    {
        ...
        explanation: 'This is a prize scam page designed to trick users into submitting personal information under the pretence of winning a reward. Amazon does not run giveaways through third-party sites. The collected information (name, address, phone, email) is sold to data brokers or used for further targeted attacks. Some variants also attempt to collect credit card details under the guise of "shipping fees".',
        recommendedActions: [
